...
<br> <a class="btn btn-primary" style="color:white;width:50px;height:35px;right:0;">เพิ่ม</a>
  ...
  foreach($books as $book){ ?>
      <tr>
        ...
        <td style="text-align:center;">
            <a class="btn btn-primary" style=""><i class="fa fa-pencil"></i></a>
...
<div style="padding:0.5em;background-color:#333;text-align:center;color:white">@copyright:2025</div>
